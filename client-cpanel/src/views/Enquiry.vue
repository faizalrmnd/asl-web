        ...
        <table class="table">
            ...
            <tbody>
                <tr v-for="(contact, index) in contacts" :key="index">
                    ...
                    <td>
                        <div class="row">
                            <div class="col-4"><a data-toggle="modal" :data-target="'#modal'+index" @click="setSelected(contact)">Balas</a></div>
                            <div class="col-4"><a @click="deleteContact(contact)">Hapus</a></div>
                        </div>
